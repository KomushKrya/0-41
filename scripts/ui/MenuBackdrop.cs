...
///
/// <c>MenuOffice.tscn</c> — форк поддерева <c>NewOffice</c> из <c>main.tscn</c> без
...
/// старом месте. Ровно так разошёлся <c>NewOffice.tscn</c>, где лампа и блокнот
/// стояли не там. Меняете расстановку в игре — перенесите её и сюда.
///
