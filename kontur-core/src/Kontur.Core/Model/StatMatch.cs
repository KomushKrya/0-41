namespace Kontur.Core.Model
{
	...
	///
	/// Сравнивается **лучший в группе**, а не сумма: порог «Интеллект 6» закрывает тот,
	/// у кого интеллект не ниже шести. Трое невнимательных не заменяют одного глазастого —
