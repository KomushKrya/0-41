...
namespace Kontur.Core.Model
{
	...
	/// тип диалога, надбавка, риски, шкалы, карантин — живут в data/radio.json,
	...
	public sealed class MissionEventOption
	{
		...
		/// <summary>
		/// Пусто — вариант доступен всегда. Иначе — id снаряжения, без которого вариант
		/// не выбрать: предмет должен быть среди отправленного именно на этот вызов.
		/// В отличие от проверки характеристик, это не про шанс, а про доступность —
		/// нет предмета, нет кнопки.
		/// </summary>
