...
namespace Kontur.Core.Events
{
	...
	/// <summary>
	/// Вариант в том виде, в каком его видит игрок: ключ, доступен ли и чего не хватает.
	///
	/// Тип диалога (хороший/нейтральный/плохой) сюда не попадает намеренно — подсказок
	/// о правильности в интерфейсе быть не должно (ДД, раздел 8). А вот причину блокировки
	/// показать нужно: «нужна Ловкость 6, у группы 4» учит игрока составлять отряд.
	/// </summary>
