...
> текстовый движок — см. `content/raw/_system/текстовый-движок.md`. Если вам в сцене нужна строка,
...
[текстовый-движок.md](текстовый-движок.md).
...
остальное — риски и шкалы — берёт из `data/radio.json`.
...
- Не хранит и не генерирует тексты. В геймплейных данных лежат только ссылки по id,
  ...
  `kontur-core/docs/CONTENT_SCHEMA.md` и `content/raw/_system/текстовый-движок.md`.
...
| Как выводить текст по id | `content/raw/_system/текстовый-движок.md` |
| Схема .md для авторов | `content/raw/_system/текстовый-движок.md` |
| Как придумывать вызовы | `content/raw/_system/текстовый-движок.md` |
