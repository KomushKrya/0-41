...
<!-- Подписи меню паузы и подсказки, общие для паузы и главного меню. Одна
     строка — одна подпись интерфейса; id ставится в коде экрана через
     Content.Label.

     Подписи самого главного меню лежат в main_menu.md. Здесь остались только
     те подсказки, которые читают оба экрана. -->
